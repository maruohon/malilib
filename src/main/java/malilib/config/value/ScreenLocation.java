...
{
    public static final ScreenLocation BOTTOM_CENTER = new ScreenLocation(VerticalAlignment.BOTTOM, HorizontalAlignment.CENTER, "bottom_center", "malilibdev.name.screen_location.bottom_center");
    public static final ScreenLocation BOTTOM_LEFT   = new ScreenLocation(VerticalAlignment.BOTTOM, HorizontalAlignment.LEFT,   "bottom_left",   "malilibdev.name.screen_location.bottom_left");
    public static final ScreenLocation BOTTOM_RIGHT  = new ScreenLocation(VerticalAlignment.BOTTOM, HorizontalAlignment.RIGHT,  "bottom_right",  "malilibdev.name.screen_location.bottom_right");
    public static final ScreenLocation CENTER        = new ScreenLocation(VerticalAlignment.CENTER, HorizontalAlignment.CENTER, "center",        "malilibdev.name.screen_location.center");
    public static final ScreenLocation CENTER_LEFT   = new ScreenLocation(VerticalAlignment.CENTER, HorizontalAlignment.LEFT,   "center_left",   "malilibdev.name.screen_location.center_left");
    public static final ScreenLocation CENTER_RIGHT  = new ScreenLocation(VerticalAlignment.CENTER, HorizontalAlignment.RIGHT,  "center_right",  "malilibdev.name.screen_location.center_right");
    public static final ScreenLocation TOP_CENTER    = new ScreenLocation(VerticalAlignment.TOP, HorizontalAlignment.CENTER,    "top_center",    "malilibdev.name.screen_location.top_center");
    public static final ScreenLocation TOP_LEFT      = new ScreenLocation(VerticalAlignment.TOP, HorizontalAlignment.LEFT,      "top_left",      "malilibdev.name.screen_location.top_left");
    public static final ScreenLocation TOP_RIGHT     = new ScreenLocation(VerticalAlignment.TOP, HorizontalAlignment.RIGHT,     "top_right",     "malilibdev.name.screen_location.top_right");
