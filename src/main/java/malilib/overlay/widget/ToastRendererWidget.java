...
public class ToastRendererWidget extends InfoRendererWidget
{
    ...
    public ToastRendererWidget()
    {
        ...
        this.setName(StringUtils.translate("malilibdev.label.misc.default_toast_renderer"));
    ...
    public void initListEntryWidget(BaseInfoRendererWidgetEntryWidget widget)
    {
        ...
        widget.setText(StyledTextLine.translate("malilibdev.hover.toast_renderer.entry_name",
