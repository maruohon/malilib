...
public class BooleanConfigStatusWidget extends BaseConfigStatusIndicatorWidget<BooleanConfig>
{
    ...
    public BooleanConfigStatusWidget(BooleanConfig config, ConfigOnTab configOnTab, String widgetTypeId)
    {
        ...
        this.textOn  = StyledTextLine.translate(STYLE_ON, "malilibdev.label.misc.on.caps");
        this.textOff = StyledTextLine.translate(STYLE_OFF, "malilibdev.label.misc.off.caps");
    ...
    protected void updateBooleanDisplayValue()
    {
        ...
        {
            String translationKey = this.lastValue ? "malilibdev.label.misc.true.lower_case" : "malilibdev.label.misc.false.lower_case";
    ...
    public enum Style
    {
        ON_OFF_TEXT     ("on_off_text",     "malilibdev.label.boolean_config_status.style.on_off_text"),
        TRUE_FALSE_TEXT ("true_false_text", "malilibdev.label.boolean_config_status.style.true_false_text"),
        ON_OFF_SLIDER   ("on_off_slider",   "malilibdev.label.boolean_config_status.style.on_off_slider"),
        ON_OFF_LIGHT    ("on_off_light",    "malilibdev.label.boolean_config_status.style.on_off_light");
    ...
    {
        ALWAYS   ("always",   "malilibdev.name.enabled_condition.always"),
        WHEN_ON  ("when_on",  "malilibdev.name.enabled_condition.when_on"),
        WHEN_OFF ("when_off", "malilibdev.name.enabled_condition.when_off");
