...
{
    /**
     * Registers a renderer which will have its {@link malilib.event.PostGameOverlayRenderer#onPostGameOverlayRender(net.minecraft.client.util.math.MatrixStack)}
    ...
    /**
     * Registers a renderer which will have its {@link malilib.event.PostItemTooltipRenderer#onPostRenderItemTooltip(net.minecraft.item.ItemStack, int, int, net.minecraft.client.util.math.MatrixStack)}
    ...
    /**
     * Registers a renderer which will have its {@link malilib.event.PostScreenRenderer#onPostScreenRender(net.minecraft.client.util.math.MatrixStack, float)}
    ...
    /**
     * Registers a renderer which will have its {@link malilib.event.PostWorldRenderer#onPostWorldRender(net.minecraft.client.util.math.MatrixStack, net.minecraft.util.math.Matrix4f, float)}
