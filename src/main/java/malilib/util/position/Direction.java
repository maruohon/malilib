...
{
    DOWN (0, -1, 1, Axis.Y, AxisDirection.NEGATIVE),
    UP   (1, -1, 0, Axis.Y, AxisDirection.POSITIVE),
    NORTH(2,  2, 3, Axis.Z, AxisDirection.NEGATIVE),
    SOUTH(3,  0, 2, Axis.Z, AxisDirection.POSITIVE),
    WEST (4,  1, 5, Axis.X, AxisDirection.NEGATIVE),
    EAST (5,  3, 4, Axis.X, AxisDirection.POSITIVE);
    ...
    Direction(int index, int oppositeId, int horizontalIndex, Axis axis, AxisDirection axisDirection)
    {
        this.index = index;
