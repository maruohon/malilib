...
public abstract class BaseNbtStringifier
{
    ...
    public BaseNbtStringifier(boolean colored, boolean useNumberSuffix, String baseColor)
    {
        ...
        this.keyColor        = StringUtils.translate("malilibdev.label.nbt_tooltip.key_color");
        this.numberColor     = StringUtils.translate("malilibdev.label.nbt_tooltip.number_color");
        this.numberTypeColor = StringUtils.translate("malilibdev.label.nbt_tooltip.number_type_color");
        this.stringColor     = StringUtils.translate("malilibdev.label.nbt_tooltip.string_color");
    }
