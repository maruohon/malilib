...
public class CustomIconListScreen extends BaseListScreen<DataListWidget<Icon>>
{
    ...
    public CustomIconListScreen()
    {
        ...
        this.addIconButton = GenericButton.create(16, "malilibdev.button.custom_icons.add_icon", this::openAddIconScreen);
        ...
        this.setTitle("malilibdev.title.screen.configs.custom_icons_list_screen", MaLiLibReference.MOD_VERSION);
    }
