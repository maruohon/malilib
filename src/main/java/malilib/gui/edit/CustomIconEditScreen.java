...
public class CustomIconEditScreen extends BaseScreen
{
    ...
    {
        this.setTitle("malilibdev.title.screen.custom_icons_edit_screen");
        ...
        this.textureNameLabel           = new LabelWidget("malilibdev.label.custom_icon_edit.texture_name");
        this.uLabel                     = new LabelWidget("malilibdev.label.custom_icon_edit.coordinate.u");
        this.vLabel                     = new LabelWidget("malilibdev.label.custom_icon_edit.coordinate.v");
        this.iconWidthLabel             = new LabelWidget("malilibdev.label.custom_icon_edit.icon_width");
        this.iconHeightLabel            = new LabelWidget("malilibdev.label.custom_icon_edit.icon_height");
        this.textureSheetWidthLabel     = new LabelWidget("malilibdev.label.custom_icon_edit.texture_sheet_width");
        this.textureSheetHeightLabel    = new LabelWidget("malilibdev.label.custom_icon_edit.texture_sheet_height");
        this.variantOffsetLabel         = new LabelWidget("malilibdev.label.custom_icon_edit.variant_offset_uv");
        this.previewLabel               = new LabelWidget("malilibdev.label.custom_icon_edit.icon_preview");
