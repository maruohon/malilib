...
public abstract class BaseOrderableListEditEntryWidget<DATATYPE> extends BaseDataListEntryWidget<DATATYPE>
{
    ...
    {
        ADD         ("malilibdev.hover.button.list.add_after", BaseOrderableListEditEntryWidget::insertEntryAfter),
        REMOVE      ("malilibdev.hover.button.list.remove",    BaseOrderableListEditEntryWidget::removeEntry),
        MOVE_UP     ("malilibdev.hover.button.list.move_up",   BaseOrderableListEditEntryWidget::moveEntryUp),
        MOVE_DOWN   ("malilibdev.hover.button.list.move_down", BaseOrderableListEditEntryWidget::moveEntryDown);
