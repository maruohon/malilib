...
public class ConfigStatusIndicatorEntryWidget extends BaseOrderableListEditEntryWidget<BaseConfigStatusIndicatorWidget<?>>
{
                                            ...
                                            ConfigStatusIndicatorContainerWidget containerWidget)
    {
        ...
        this.configureButton = GenericButton.create(16, "malilibdev.button.misc.configure", this::openEditScreen);
        this.removeButton = GenericButton.create(16, "malilibdev.button.misc.remove", this::removeInfoRendererWidget);
