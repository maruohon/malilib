...
public class OptionListConfigButton extends GenericButton
{
                                                                       ...
                                                                       List<StyledTextLine> previousLines)
    {
        ...
        {
            lines.add(StyledTextLine.translate("malilibdev.hover.config.option_list.total_values.all", totalValues));
        }
        else
        {
            lines.add(StyledTextLine.translate("malilibdev.hover.config.option_list.total_values.allowed",
        ...
        for (OptionListConfigValue value : allValues)
        {
            if (allowedValues.contains(value))
            {
                ...
                {
                    lines.add(StyledTextLine.translate("malilibdev.hover.config.option_list.selected_value",
                                                       value.getDisplayName()));
                }
                else
                {
                    lines.add(StyledTextLine.translate("malilibdev.hover.config.option_list.non_selected_value",
                                                       value.getDisplayName()));
                }
            }
        }
        ...
        {
            lines.add(StyledTextLine.EMPTY);
            lines.add(StyledTextLine.translate("malilibdev.hover.config.option_list.total_values.disallowed",
        ...
        lines.add(StyledTextLine.EMPTY);
        lines.add(StyledTextLine.translate("malilibdev.hover.config.option_list.default_value",
