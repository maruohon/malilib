...
public class ActionPromptScreen extends BaseListScreen<DataListWidget<NamedAction>>
{
    ...
    public ActionPromptScreen()
    {
        ...
        String label = "malilibdev.checkbox.action_prompt_screen.remember_search";
        String hoverKey = "malilibdev.hover.action.prompt_screen.remember_search_text";
        ...
        label = "malilibdev.checkbox.action_prompt_screen.fuzzy_search";
        hoverKey = "malilibdev.hover.action.prompt_screen.use_fuzzy_search";
        ...
        label = "malilibdev.checkbox.action_prompt_screen.search_display_name";
        hoverKey = "malilibdev.hover.action.prompt_screen.search_display_name";
