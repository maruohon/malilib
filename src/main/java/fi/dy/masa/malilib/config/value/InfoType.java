...
public class InfoType extends BaseOptionListConfigValue
{
    ...
    public static final InfoType TOAST           = new InfoType("toast",          "malilib.label.info_type.toast");
    ...
    public static final ImmutableList<InfoType> VALUES = ImmutableList.of(MESSAGE_OVERLAY, TOAST, CUSTOM_HOTBAR, VANILLA_HOTBAR, CHAT, NONE);
