...
public class ConfigOptionListEntry<T extends ConfigOptionListEntry<T>> implements IConfigOptionListEntry<T>
{
    ...
    public ConfigOptionListEntry(String configString, String translationKey)
    {
     ...
     * @return
     */
    public static <T extends IConfigOptionListEntry<T>> T cycleValue(List<T> values, int currentIndex, boolean forward)
    {
     ...
     * @return
     */
    public static <T extends IConfigOptionListEntry<T>> T findValueByName(String name, List<T> values)
    {
        for (T val : values)
        {
    ...
    public static <T extends ConfigOptionListEntry<T>> ImmutableList<T> initValues(ImmutableList<T> values)
    {
        for (T val : values)
        {
            val.init(values);
