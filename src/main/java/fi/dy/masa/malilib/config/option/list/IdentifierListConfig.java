...
{
    public IdentifierListConfig(String name, ImmutableList<Identifier> defaultValues, Function<Identifier, String> toStringConverter, Function<String, Identifier> fromStringConverter)
    {
        super(name, defaultValues, toStringConverter, fromStringConverter);
    }

    public IdentifierListConfig(String name, ImmutableList<Identifier> defaultValues, String comment, Function<Identifier, String> toStringConverter, Function<String, Identifier> fromStringConverter)
    {
