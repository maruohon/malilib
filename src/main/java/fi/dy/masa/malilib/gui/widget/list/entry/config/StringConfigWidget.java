...
public class StringConfigWidget extends BaseConfigOptionWidget<StringConfig>
{
    ...
    protected void reCreateWidgets(int x, int y)
    {
        ...
        final WidgetTextFieldBase textField = new WidgetTextFieldBase(x + xOff, y + 3, elementWidth, 16, this.config.getStringValue());
        ...
        resetButton.setActionListener((btn, mbtn) -> {
            ...
            textField.setText(this.config.getStringValue());
        });
