...
public class BaseConfigTab implements ConfigTab
{
    ...
    private final BiFunction<ConfigTab, BaseConfigScreen, IButtonActionListener> listenerFactory;
    ...
    public BaseConfigTab(String translationKey, int configWidth, boolean useKeyBindSearch,
                         List<? extends ConfigInfo> configs, BiFunction<ConfigTab, BaseConfigScreen, IButtonActionListener> listenerFactory)
    {
    ...
    @Override
    public IButtonActionListener getButtonActionListener(BaseConfigScreen gui)
    {
