...
public abstract class WidgetBase
{
    ...
    public void drawString(int x, int y, int color, String text, DrawContext context)
    {
        context.drawText(this.textRenderer, text, x, y, color, false);
    }

    public void drawCenteredString(int x, int y, int color, String text, DrawContext context)
    {
        context.drawText(this.textRenderer, text, x - this.getStringWidth(text) / 2, y, color, false);
    }

    public void drawStringWithShadow(int x, int y, int color, String text, DrawContext context)
    {
        context.drawTextWithShadow(this.textRenderer, text, x, y, color);
    }

    public void drawCenteredStringWithShadow(int x, int y, int color, String text, DrawContext context)
    {
        context.drawTextWithShadow(this.textRenderer, text, x - this.getStringWidth(text) / 2, y, color);
    }
