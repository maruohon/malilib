...
public class WidgetRadioButton<T extends Enum<T>> extends WidgetBase
{
    ...
    public static class IconProvider implements IIconProvider<IconType>
    {
        ...
        public IGuiIcon getIconFor(IconType type)
        {
            switch (type)
            {
                case UNSELECTED:        return BaseGuiIcon.RADIO_BUTTON_UNSELECTED_NORMAL;
                case UNSELECTED_HOVER:  return BaseGuiIcon.RADIO_BUTTON_UNSELECTED_HOVER;
                case SELECTED:          return BaseGuiIcon.RADIO_BUTTON_SELECTED_NORMAL;
                case SELECTED_HOVER:    return BaseGuiIcon.RADIO_BUTTON_SELECTED_HOVER;
            }
