...
public class GuiKeybindSettings extends GuiDialogBase
{
    ...
    public GuiKeybindSettings(IKeybind keybind, String name, @Nullable IDialogHandler dialogHandler, Screen parent)
    {
        ...
        this.title = GuiBase.TXT_BOLD + I18n.translate("malilib.gui.title.keybind_settings.advanced", this.keybindName) + GuiBase.TXT_RST;
    ...
    {
        this.addLabel(x, y + 4, labelWidth, 10, 0xFFFFFFFF, I18n.translate(config.getPrettyName()));
