...
public class DataListEntrySelectionHandler<DATATYPE>
{
    ...
    @Nullable protected ISelectionListener<DATATYPE> selectionListener;
    ...
    public DataListEntrySelectionHandler<DATATYPE> setSelectionListener(ISelectionListener<DATATYPE> listener)
    {
    ...
    @Nullable
    public ISelectionListener<DATATYPE> getSelectionListener()
    {
