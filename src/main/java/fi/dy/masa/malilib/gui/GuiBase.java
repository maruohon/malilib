...
public abstract class GuiBase extends Screen implements IMessageConsumer, IStringConsumer
{
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawTitle(context, mouseX, mouseY, partialTicks);
        ...
        this.drawContents(context, mouseX, mouseY, partialTicks);

        this.drawButtonHoverTexts(mouseX, mouseY, partialTicks, context);
    ...
    protected void drawGuiMessages(DrawContext context)
    {
        this.messageRenderer.drawMessages(this.width / 2, this.height / 2, context);
    }
    ...
    {
        this.drawString(context, this.getTitleString(), LEFT, TOP, COLOR_WHITE);
    }

    protected void drawContents(DrawContext context, int mouseX, int mouseY, float partialTicks)
    {
    }

    protected void drawButtons(int mouseX, int mouseY, float partialTicks, DrawContext context)
    {
        for (ButtonBase button : this.buttons)
        {
            button.render(mouseX, mouseY, button.isMouseOver(), context);
        }
    }
    ...
    protected void drawTextFields(int mouseX, int mouseY, DrawContext context)
    {
        for (TextFieldWrapper<?> entry : this.textFields)
        {
            entry.draw(mouseX, mouseY, context);
        }
    }

    protected void drawWidgets(int mouseX, int mouseY, DrawContext context)
    {
    ...
    protected void drawButtonHoverTexts(int mouseX, int mouseY, float partialTicks, DrawContext context)
    {
        ...
        for (ButtonBase button : this.buttons)
        {
            ...
            {
                RenderUtils.drawHoverText(mouseX, mouseY, button.getHoverStrings(), context);
            }
        }
    }
    ...
    protected void drawHoveredWidget(int mouseX, int mouseY, DrawContext context)
    {
        if (this.shouldRenderHoverStuff() == false)
        {
            return;
        ...
        {
            this.hoveredWidget.postRenderHovered(mouseX, mouseY, false, context);
        }
    }
    ...
    public void drawStringWithShadow(DrawContext context, String text, int x, int y, int color)
    {
